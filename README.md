...
- `index.html`：可直接发布的网站和 85 个视频记录的事实来源。
...
截至 `2026-09-01`，已验证覆盖为 **85** 个视频：**78** 条站内中文字幕轨、**0** 条 `no-speech`、**7** 条 `missing`，共 **22,797** 个 cues。不要把这表述为“全部视频都有字幕”；`missing` 是有证据、可播放且应如实保留的状态。
