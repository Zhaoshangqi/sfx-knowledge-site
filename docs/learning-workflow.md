...
批量人工核对期间可运行 `node .\tools\verify-portable-kit.cjs --allow-incomplete-timeline`，该开关只暂时放宽时间线完整度，公开案例身份和截图资产仍必须有效。最终发布必须去掉此开关，使默认校验达到 84/84 条已核对视频、947/947 个步骤时间、97/97 个公开案例时间与截图审查，以及 870/870 个步骤截图资产。
