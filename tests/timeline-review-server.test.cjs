...
test('runCli projects exactly the 101 curated public effect cases from the real site', async () => {
  ...
  assert.equal(caseIds.length, 101);
  assert.equal(new Set(caseIds).size, 101);
